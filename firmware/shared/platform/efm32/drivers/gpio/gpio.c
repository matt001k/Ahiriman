...
static gpio_PinDefs_t pDef[NUM_GPIO] = 
{
    ...
    [I2S_FS] = {PORTA, PIN3, PUSHPULLALT, GPIO_CLEAR},
    [I2S_ADCOUT] = {PORTA, PIN1, PUSHPULLALT, GPIO_CLEAR},
    [I2S_DACIN] = {PORTA, PIN0, PUSHPULLALT, GPIO_CLEAR},
    [I2S_MCLK] = {PORTA, PIN12, PUSHPULLALT, GPIO_CLEAR},
    [I2S_SCLK] = {PORTD, PIN7, PUSHPULLALT, GPIO_CLEAR},
    [I2S_SDIO] = {PORTD, PIN6, PUSHPULLALT, GPIO_CLEAR},
